...
(function(root, factory) {
  ...
  describe('TreatmentOptions', function() {
    ...
    it('should have the property disease (base name: "disease")', function() {
      // uncomment below and update the code to test the property disease
      //var instane = new FluxNotesTreatmentOptionsRestClient.TreatmentOptions();
    ...
    it('should have the property dxGrade (base name: "dxGrade")', function() {
      // uncomment below and update the code to test the property dxGrade
      //var instane = new FluxNotesTreatmentOptionsRestClient.TreatmentOptions();
      //expect(instance).to.be();
    });
